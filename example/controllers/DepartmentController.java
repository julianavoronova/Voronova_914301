...
public class DepartmentController {
    ...
    @GetMapping ("/find/{id}")
    public Department calculateSalary (@PathVariable(name = "id") Integer id) {
...
//        return salary * 1.13;
    ...
    @PostMapping ("/edit/{id}")
    public Department updateDepartment (@PathVariable (name = "id") Integer id, @RequestParam String name, String address, String phone, Model model) {
        Department department = departmentService.get(id);
