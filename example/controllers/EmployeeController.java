...
@RestController
@RequestMapping("/admin/employee")              // сейчас только для администратора
...
//    }
    ...
    @PostMapping ("/edit/{id}")
    public Employee updateEmployee (@PathVariable (name = "id") Integer id, @RequestParam String name, String nationality, String department, String position, String date_hire, int kids, String bank_account, Model model) {
